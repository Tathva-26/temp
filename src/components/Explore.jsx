          ...
          <div className='relative w-full h-[40vh] sm:h-80 md:h-[600px] flex items-start md:items-center'>
            {sections.map((section, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`absolute left-0 right-0 md:right-8 lg:right-16 transition-all duration-[800ms] flex flex-col justify-center ${
                    isActive
                ...
                >
                  ...
                  <div
                    className={`w-16 h-1 mb-6 transition-all duration-[800ms] delay-100 ${
                      isActive
                        ? 'bg-cyan-400 scale-x-100 origin-left'
                        : 'bg-white/20 scale-x-50 origin-left'
                    }`}
                    style={{
                      transitionTimingFunction: 'cubic-bezier(0.16, 1, 0.3, 1)',
                    }}
                  ...
                  <Link
                    href={route}
                    className='group flex items-center gap-3 sm:gap-4 w-fit whitespace-nowrap'
                  >
                    ...
                    <ArrowRight className='shrink-0 w-8 h-8 md:w-6 md:h-6 lg:w-8 lg:h-8 -rotate-45 transition-all duration-300 group-hover:rotate-0 group-hover:translate-x-1 opacity-100 text-cyan-400' />
                  </Link>

                  <p
                    className={`mt-6 text-white/80 text-sm sm:text-base font-light max-w-lg leading-relaxed transition-all duration-[800ms] delay-150 drop-shadow-md ${
                      isActive
