...
const EDITABLE_FIELDS = [
  ...
  { key: "college", label: "College", type: "text", placeholder: "NIT Calicut" },
  { key: "branch", label: "Branch", type: "text", placeholder: "CSE" },
  { key: "semester", label: "Semester", type: "number", min: 1, max: 10 },
  { key: "year", label: "Year", type: "number", min: 1, max: 5 },
  { key: "district", label: "District", type: "text", placeholder: "Kozhikode" },
...
export default function ProfileSummary({ user }) {
  ...
  const { bookings, eventsByTiqrId, loading, error, reload } = useMyBookings(
    !!user,
  );
