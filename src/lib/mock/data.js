...
export const MOCK_EVENTS = [
  ...
  event({
    ...
    extraInfo: 'Build your first AI assistant in one afternoon.',
    datetime: day(0, 10),
    time: '10:00 AM',
    price: 25000,
    venue: venues.cs,
  ...
  event({
    ...
    extraInfo: 'Sleep is optional. Shipping is not.',
    datetime: day(1, 18),
    startTime: day(1, 18),
    endTime: day(2, 18),
    price: 30000,
  ...
  event({
    ...
    extraInfo: 'Only one bot leaves the arena.',
    datetime: day(2, 13),
    price: 50000,
    venue: venues.ground,
    picture: `${CDN_BASE_URL}/images/events.jpg`,
  ...
  event({
    ...
    description: 'Unpublished workshop: Booking full.',
    datetime: day(1, 14),
    price: 20000,
    venue: venues.cs,
    published: false,
  ...
  event({
    type: 'workshops',
    heading: 'PCB Design Masterclass',
    description: 'Unpublished workshop: Booking full.',
    datetime: day(2, 11),
    price: 35000,
    venue: venues.ee,
  ...
  event({
    type: 'workshops',
    heading: 'Cloud Native Deployments',
    description: 'Unpublished workshop: Booking full.',
    datetime: day(3, 10),
    price: 15000,
    venue: venues.cs,
  ...
  event({
    type: 'competitions',
    heading: 'Circuit Debugging Race',
    description: 'Unpublished competition: Booking full.',
    datetime: day(3, 13),
    price: 7500,
    venue: venues.ee,
  ...
  event({
    type: 'lectures',
    heading: 'Future of Quantum Networks',
    description: 'Unpublished lecture: Booking full.',
    datetime: day(1, 16),
    price: 0,
    venue: venues.arc,
