...
export default function WorkshopsPage() {
  ...
  const startCallout = (id, slotEl, workshop) => {
    ...
    const priceText = `₹${workshop.price != null ? workshop.price / 100 : "N/A"}`;
  ...
  const sortedWorkshops = useMemo(() => {
    ...
    return [
      ...filtered.filter((w) => !w.picture?.trim().endsWith("-DUMMY.jpg")),
      ...filtered.filter((w) => w.picture?.trim().endsWith("-DUMMY.jpg")),
    ];
                    ...
                    >
                      ...
                      >
                        <Link
                          href={workshopHref}
                          className="block"
                          onClick={(e) => handleCardClick(e, id, workshopHref, displayImage)}
                        >
                          <div
                            style={{
                              position: "relative",
